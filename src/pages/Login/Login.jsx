...
import { loginCall, registerNewUserCall } from "../../services/apiRoutes";
                ...
                <div className="col text-center ">
                    <div className="container row">
                        ...
                        <div className="col m-5   text-center">
                            <div className="col m-0 text-light fst-italic text-warning-emphasis "><h1>Bienvenido Casalarter</h1></div>
                            <div className="col m-0 text-light fst-italic "><p className="text-secondary">Si aun no eres un Casalarter registrate aqui <button className="btn-primary bg-light text-primary link-opacity-10-hover m-0 p-0" onClick={handleShow}>Registro</button> </p></div>
                            <div>
                                <div className="row  text-end" >
                                    <InputGroup className="mb-4 form-control bg-black"  >
                                        <InputGroup.Text className="border-success bg-black text-light  "  >Email</InputGroup.Text>
                                        <Form.Control className="border-success bg-black text-light " onChange={inputChangedLogin} name="email" type="email" />

                                    </InputGroup>
                                </div>

                                <div className="row text-end">
                                    <InputGroup className="mb-2 form-control  bg-black"  >
                                        <InputGroup.Text className="border-success bg-black text-light ">Password</InputGroup.Text>
                                        <Form.Control className="form-control border-success bg-black text-light " onChange={inputChangedLogin} name="password" type="password" />
